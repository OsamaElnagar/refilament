...
function SheetPortal({
  ...props
}: Omit<React.ComponentProps<typeof SheetPrimitive.Portal>, "keepMounted">) {
  ...
  return (
    <SheetPortal>
      ...
      <SheetPrimitive.Popup
        ...
        className={cn(
          "bg-background fixed z-50 flex flex-col gap-4 shadow-lg transition ease-in-out data-[open]:duration-500 data-ending-style:duration-300",
          side === "right" &&
